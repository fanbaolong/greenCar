...
public class LogUtils {
	private static String TAG = "Ganyizhi";
	...
	private static String getFunctionName() {
		...
		for (StackTraceElement st : sts) {
			...
			// Log.i(TAG,
			// st.getClassName()+"=="+LogUtils.class.getClass().getName()+"=="+Thread.class.getName()+"==="+LogUtils.class.getSimpleName());
	...
	public static void error(String name, String str) {
		if (isDebug)
			Log.e(TextUtils.isEmpty(name) ? "API-request" : name, str);
	}
